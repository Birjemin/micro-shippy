...
import (
    ...
    userService "github.com/birjemin/micro-shippy/user-service/proto/user"
    vesselProto "github.com/birjemin/micro-shippy/vessel-service/proto/vessel"
...
func main() {
    ...
    // Init will parsGetAlle the command line flags.
    srv.Init()
